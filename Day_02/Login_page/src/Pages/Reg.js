        ...
        <MDBCol md='6'>
          ...
          <MDBCard className='my-5'>
            <MDBCardBody className='p-5'>
              ...
              <MDBInput wrapperClass='mb-4' label='Phone' id='form1' type='number' required/>
              <MDBInput wrapperClass='mb-4' label='Password' id='form1' type='password' required/>

              <a href='#12'><button className="btn btn-primary mb-4 px-5" type="button">Register</button></a>
